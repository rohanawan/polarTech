...
class RangeOrOvenRepair extends React.Component {

    state = {
        pageTitle: "Range or Oven Repair Services",
    ...
    render() {
        ...
        return (
            <AnimationRevealPage disabled>
                <Helmet>
                    <title> {PageTitlesAndDescription.ServicesSubPages.RangeOrOvenRepair.title}  </title>
                    <meta name="description" content={PageTitlesAndDescription.ServicesSubPages.RangeOrOvenRepair.description} />
                </Helmet>
                <NavBar />
                <WhatsApp />
...
export default RangeOrOvenRepair;
